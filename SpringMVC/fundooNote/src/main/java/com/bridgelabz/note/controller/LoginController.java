...
public class LoginController {
	...
	public @ResponseBody ResponseEntity<Response> loginUser(@RequestBody Login login, BindingResult bindResult, HttpServletRequest req) {
		...
		try {
			...
			if (null != user) {
				...
				resp.setStatus(1);
				resp.setMsg("User exists!!Login successfull");
